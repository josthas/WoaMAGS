...
public class PreferencesActivity extends PreferenceActivity
{
	...
	private native boolean readConfigFile(String directory, boolean is_phone);
	private native boolean writeConfigFile(boolean is_phone);
    ...
    private boolean isTabletDevice()
    {
        return true;
        /*
        boolean device_large = ((this.getApplicationContext().getResources().getConfiguration().screenLayout &
	...
	public void onCreate(Bundle bundle)
	{
		...
		boolean hasCustomConfig = readConfigFile(gamePath, !isTabletDevice());
