...
public class ExpansionDownloaderActivity extends AppCompatActivity implements IDownloaderClient {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.downloader_ui);
        /**
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        mProgressPercent.setText(getString(R.string.progress_percent,
                progress.mOverallProgress * 100 / progress.mOverallTotal) + " " + getString(R.string.time_remaining, Helpers.getTimeRemaining(progress.mTimeRemaining)));
