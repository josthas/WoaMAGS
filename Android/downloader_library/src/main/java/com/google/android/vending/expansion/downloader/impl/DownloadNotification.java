/*
 * Portions Copyright (C) 2016 MonkeyMoto Productions, Inc.
 *
 * Notification updated to use
 * android.support.v4.app.NotificationCompat.Builder for
 * compatibility with newer platform versions.
 *
 * Modifications submitted to the public domain without
 * reservation.
 */
