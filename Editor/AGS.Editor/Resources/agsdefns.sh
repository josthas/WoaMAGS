...
managed struct Room {
  /// Gets an integer Custom Property associated with is room.
  ...
  import static String SetTextProperty(const string property, const string value);
  /// Sets an integer custom property for this item.
  import static int SetProperty(const string property, const int value);
...
managed struct Game {
  ...
  import static void   SimulateKeyPress(int key);
...
managed struct Label extends GUIControl {
  ...
  /// Gets/sets the text alignment for the label text.
