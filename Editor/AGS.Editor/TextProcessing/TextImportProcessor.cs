...
namespace AGS.Editor
{
    public class TextImportProcessor : GameSpeechProcessor
    {
        ...
        {
            string[] doNotTranslateCalls = new string[] { "Display(", "DisplayDebug(", "String.Format(", "IndexOf(", "NoTranslate(", "DoOnce(", "Property(", "Property (", "PropertyText(", "PropertyText (", "WriteRawLine(", "Replace(", "ErrorQuit(", "SimpleSetGlyph(", "SimpleSetSymbols(" };
