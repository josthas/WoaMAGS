...
namespace AGS.Editor
{
    public class TranslationSourceProcessor : GameSpeechProcessor
    {
        ...
        {
            string[] doNotTranslateCalls = new string[] { "Display(", "DisplayDebug(", "String.Format(", "IndexOf(", "NoTranslate(", "DoOnce(", "SetProperty(", "GetProperty(", "SetTextProperty(", "GetTextProperty(", "Property(", "Property (", "PropertyText(", "PropertyText (", "WriteRawLine(", "Replace(", "ErrorQuit(", "SimpleSetGlyph(", "SimpleSetSymbols(" };
