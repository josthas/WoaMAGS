...
// AGS2Client Modification Note:
// This header file has been modified from its original version
// for the AGS2Client API. These modifications do not modify the
// runtime usage of this header file by the AGS engine, and were
// made to correct compile-time compatibility issues. All
// modifications from the original version of this header file
...
#define BITMAP char
#define AGS2CLIENT_DEFINED_BITMAP
#endif // !ALLEGRO_H and !_WINGDI_

// If not using windows.h, define HWND
//#ifndef _WINDOWS_ // EXISTING API PREPROCESSOR CHECK
// AGS2Client Modification Note:
// MinGW is complaining about duplicate definition with only the check for _WINDOWS_
// (which is defined in WINDOWS.H), despite every file including WINDOWS.H *BEFORE*
// it includes AGSPLUGIN.H. The additional check for WINDEF.H seems to resolve this.
#if !defined(_WINDOWS_) && !defined(_WINDEF_H)
#define HWND int
#define AGS2CLIENT_DEFINED_HWND
#endif // _WINDOWS_
...
#define __stdcall
#endif // DJGPP or LINUX_VERSION or MAC_VERSION

#ifndef int32
#define int32 long // EXISTING API DEFINITION
// AGS2Client Modification Note:
// The above definition works fine for this file, but the other APIs may declare int32 themselves.
// To prevent meaningless and/or conflicting defintions, we'll just undef this at the end of the file.
#define AGS2CLIENT_DEFINED_INT32
#endif // int32
...
// AGS2Client Modification Note:
// undef int32 (if it was defined by this header) to prevent issues with other APIs.
#ifdef AGS2CLIENT_DEFINED_INT32
#ifdef int32
#undef int32
#endif // int32
#undef AGS2CLIENT_DEFINED_INT32
#endif // AGS2CLIENT_DEFINED_INT32

#ifdef AGS2CLIENT_DEFINED_BITMAP
#ifdef BITMAP
#undef BITMAP
#endif // BITMAP
#undef AGS2CLIENT_DEFINED_BITMAP
#endif // AGS2CLIENT_DEFINED_BITMAP

#ifdef AGS2CLIENT_DEFINED_HWND
#ifdef HWND
#undef HWND
#endif // HWND
#endif // AGS2CLIENT_DEFINED_HWND
