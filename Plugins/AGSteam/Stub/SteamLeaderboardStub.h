...
//
#ifndef AGSTEAM_STEAMLEADERBOARDSTUB_H
#define AGSTEAM_STEAMLEADERBOARDSTUB_H
...
class SteamLeaderboardStub : public ISteamLeaderboard
{
public:
    void FindLeaderboard(char const*)
    {
    }

    bool UploadScore(int)
    {
        return false;
    }
    ...
    char const* GetLeaderName(int)
    {
        return 0U;
    }

    int GetLeaderScore(int)
    {
        return 0;
    }
    ...
    ~SteamLeaderboardStub()
    {
    }
};

SteamLeaderboardStub& GetSteamLeaderboardStub();

} // namespace Stub
} // namespace AGSteam

#endif // AGSTEAM_STEAMLEADERBOARDSTUB_H
