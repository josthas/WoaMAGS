...
// AGSteam Modification Note:
// The above definition works fine for this file, but the Steam API also declares int32 as a global typedef.
// To prevent meaningless and/or conflicting defintions, we'll just undef this at the end of the file.
#define AGSTEAM_DEFINED_INT32
#endif // int32
...
// AGSteam Modification Note:
// undef int32 (if it was defined by this header) to prevent issues with the Steam API.
#ifdef AGSTEAM_DEFINED_INT32
#ifdef int32
#undef int32
#endif // int32
#undef AGSTEAM_DEFINED_INT32
#endif // AGSTEAM_DEFINED_INT32

#ifdef AGSTEAM_DEFINED_BITMAP
#ifdef BITMAP
#undef BITMAP
#endif // BITMAP
#undef AGSTEAM_DEFINED_BITMAP
#endif // AGSTEAM_DEFINED_BITMAP

#ifdef AGSTEAM_DEFINED_HWND
#ifdef HWND
#undef HWND
#endif // HWND
#endif // AGSTEAM_DEFINED_HWND
